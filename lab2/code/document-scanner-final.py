...
Roll No: 18307R004
Title: cs763_lab2_document-scanner-manual
x------------------x--------------------x
Readme:
    ...
    also then show the transformed image. Use EXC key to exit from thw display windows.
"""
...
if __name__ == "__main__":
    ...
    cv2.waitKey(0)
    cv2.imwrite("not-working-out.jpg", SCANNED)
